...
export const Navbar = ({ className }) => {
  ...
  const [shadow, setShadow] = useState(false); // State untuk shadow
  ...
  return (
    <>
      <nav
        className={`sticky w-full bg-white top-0 z-50 transition-all duration-500 ease-in-out ${className} ${shadow ? 'shadow-lg' : ''}`} // Menambahkan class shadow
        ref={inViewRef}
        style={{
